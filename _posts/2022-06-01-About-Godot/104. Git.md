...
If you dont have a .gitignore which should remove the unnecessary files from saving to our repository, we can ask GitHub to give us one when we create the repository. There will be an option specifically for Godot.
