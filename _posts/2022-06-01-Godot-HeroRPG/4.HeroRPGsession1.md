## Hero RPG a Role Playing Game, session 1
...
![](session1-images/saveAfewAssets.png)
...
![](session1-images/EditorPanels.png)
...
![](session1-images/createTheScene2.png)
...
![](session1-images/moveAndResize.png)
...
![](session1-images/createTheScene.png)
...
![](session1-images/createTheScene3.png)
...
![](session1-images/play-to-see-1.png)

press Play or f5 to run. Your app should look something like


![](session1-images/scene-run1.png)
