## Hero RPG a Role Playing Game, session 5
...
![](session5-images/mayor_in_editor.png)
...
![](session5-images/playor_mayor_walk_around_text.png)
...
![](session5-images/using_ysort.png)

I placed the lovely couple together.

![](session5-images/cute_souple.png)
...
![](session5-images/origin_step1.png)

Click on AnimatedSprite and drag it up.

![](session5-images/origin_step2.png)

Clcik on CollisionShape2D and drag it up.

![](session5-images/origin_step3.png)
