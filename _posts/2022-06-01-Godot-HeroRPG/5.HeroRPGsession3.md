## Hero RPG a Role Playing Game, session 3
...
![](session3-images/AddProjectSettingInputKeys.png)
...
![](session3-images/added_left.png)
...
![](session3-images\select_clapboard_to_open_player_scene.png)

+ OR Go to the file-system (bottom left or1 panel 5).

![](session3-images/select_player_scene.png)

First we need to create a script.

![](session3-images/add_script.png)
...
![](session3-images/first_script.png)
...
![](session3-images/exported_variables.png)
...
![](session3-images/directions.png)
...
![](session3-images/selecting_script.png)
...
![](session3-images/compare_animation_names.png)
...
![](session3-images/code_errors.png)
...
![](session3-images/stop_the_game.png)
