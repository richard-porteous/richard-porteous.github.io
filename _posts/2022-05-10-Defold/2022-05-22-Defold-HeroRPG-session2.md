...
![](/img/session2-images\add_mayor.png)
...
![](/img/session2-images/player_image_and_animations.png)
...
![](/img/session2-images/add_player_collection_to_main_collection.png)

![](/img/session2-images/player_added.png)
...
![](/img/session2-images/scale_mayor.png)
...
![](/img/session2-images/scale_player.png)
...
![](/img/session2-images/input_bindings.png)
...
![](/img/session2-images/add_a_key.png)

The Keys added.

![](/img/session2-images/added_key_input_bindings.png)
...
![](/img/session2-images/create_move_script.png)
...
*add component file*
![](/img/session2-images/add_script_1.png)

*select the script*
![](/img/session2-images/add_script_2.png)
...
![](/img/session2-images/camera_to_follow_player.png)

![](/img/session2-images/outline_for_camera_follow_test.png)


### **OK lets run it**
Save(Ctrl-S) and run (f5)

![](/img/session2-images/first_time_run.png)
...
+ ![](/img/session2-images/documentation.png)
