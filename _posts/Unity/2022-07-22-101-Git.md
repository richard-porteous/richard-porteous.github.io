## Unity - Safety with Git

It is highly recommended that you make this a habit if you don't want to loose your work.

### What we will do this Lesson:
Let's have a quick discussion about keeping the work you have done safely

Git keeps track of your changes on your hard-drive and it can sync with a remote private (or public) repository. A personal remote repository can be stored with GitHub or Bitbucket which are the most common in this part of the world.

#### git-gui or GitAhead etc.
...
Notice the project files and folders. 

If you dont have a .gitignore which should remove the unnecessary files from saving to our repository, we can ask GitHub to give us one when we create the repository. There will be an option specifically for Unity.
...
(URL should look like https://github.com/YOUR_NAME/PROJECT_NAME.git ... where YOUR_NAME is the name you chose during signup and  is ...well... the project name.PROJECT_NAME)
...
![](/img/git/grab_location_for_project.png)

o	go to the project folder ... mine is cd C:\Users\richp\DefoldProjects\PROJECT_NAME ~ PROJECT_NAME is the project name of your choosing.

![](/img/git/cmd_goto_project.png)
...
NOTE EXAMPLE COMMANDS - don't do this yet: 
...
![](/img/git/git_cmd_commands.png)

Note I use *main* as the default branch. You may have *master* instead. (can be changed in your GitHub profile ~ but change it now if you want it changed).

#### Now we push it upstream

Use the URL given in the instructions from github

+ git remote add origin https://github.com/YOUR-NAME/PROJECT_NAME.git
...
I recommend GitAhead ... but Git comes with a GUI client if you haven't downloaded another client.
...
+ SourceTree - free -  can find on BitBucket's site
+ GitHub Desktop - free - https://docs.github.com/en/desktop (keeps it simple)
